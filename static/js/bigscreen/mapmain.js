            ...
            for (var i = 0; i < zddws.length; i++) {
                ...
                marker.addEventListener("click", function (e) {
                    ...
                    var contents =
                        ...
                        this.dwdzData +
                        '</div>' +
                        '<table cellpadding="0" cellspacing="0" class="content" style="height:100px; width:550px;white-space: normal;">' +
                        '<tr>' +
