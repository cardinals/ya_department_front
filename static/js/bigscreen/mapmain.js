...
var vm = new Vue({
    ...
    methods: {
        ...
        drawMap: function () {
            var content =
                '<div class="app-map-infowindow water-xhs-infowindow" style="min-weight:240px;min-height: 184px;background-position: right bottom; background-repeat: no-repeat;" >' +
                ...
                '</tr>' +
                '<tr>' +
                '<td><strong>预案查看：</strong><a>总队级预案</a></td>' +
                '</tr>' +
                '<tr>' +
                '<td><strong>预案查看：</strong><a>支队级预案</a></td>' +
                '</tr>' +
                '<tr>' +
                '<td><strong>预案查看：</strong><a>大中队级预案</a></td>' +
                '</tr>' +
                '</table>' +
